    ...
    <nav class="deep-purple darken-4">
        <div class="nav-wrapper">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a style="font-size:larger;" href="#">TP2 - index</a></li>
            </ul>
        </div>
    </nav>
</head>
        ...
        <div class="row">
            ...
            <div class="row">
                <form action="" method="post" class="col s12">
                    ...
                    <div class="row">
                        <button id="send" class="btn waves-effect waves-light teal darken-3 col s12" type="submit" name="action">Se connecter
                            <i class="material-icons right">send</i>
                        </button>
                        <div class="input-field right">
                            <a class="waves-effect waves-light btn-large" href="subscription.php">Je n'ai pas de compte ?</a>
                        </div>
                    </div>
                </form>
            </div>
