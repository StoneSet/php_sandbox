    ...
    <nav class="deep-purple darken-4">
        <div class="nav-wrapper">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a style="font-size:larger;" href="#">TP2 - page2</a></li>
            </ul>
        </div>
    </nav>
</head>
